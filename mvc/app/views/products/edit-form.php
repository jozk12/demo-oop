...
<body>
<form action="<?= getClientUrl('save-edit-product',[$id=>$model->id]) ?>" method="post" enctype="multipart/form-data">
    <div class="div">
    ...
    <div class="div">
        <label for="">Giá</label>
        <input type="mumber" name="price" id="" value="<?= $model->name?>>
    </div>
    <div class="div">
        <label for="">Số lượng</label>
        <input type="mumber" name="quantity" id="" value="<?= $model->name?>>
    </div>
    <div class="div">
